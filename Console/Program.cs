...
class Program
{
    ...
    static void ChooseSortingType(string input)
    {
        ...
        {
            Console.WriteLine("Недопустимый выбор: не целое число");
            return;
        }
        ...
        {
            Console.WriteLine("Выбран недопустимый вариант сортировки.");
        }
    ...
    static int GetRandomIndex(int maxLength)
    {
        ...
        using (var client = new HttpClient())
        {
            try
            {
                ...
                {
                    Console.WriteLine("HTTP ошибка 400 Bad Request. Генерируем локальное случайное число");
